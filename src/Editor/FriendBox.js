var FriendBox = cc.Layer.extend({
	ctor:function(width, height, name, count, playFlag, rank){
		...
		this.nameLabel = new cc.LabelTTF(this.name, "HeaderFont", Math.floor(this.height*.4));
		...
		this.countText = new cc.LabelTTF(this.count, "HeaderFont", Math.floor(this.height*.3));
