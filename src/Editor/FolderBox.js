var FolderBox = cc.Layer.extend({
	ctor:function(width, height, bubbleTypes, bubbleColors, title){
		...
		this.dn.drawRect(cc.p(0,0), cc.p(this.width,this.height), cc.color(245,245,245,255), 1, cc.color(0,0,0,255));
		...
		cc.log(sortedTypes);*/
		var sortedTypes = this.bubbleTypes;
		...
		for(var i=0; i<sortedTypes.length; i++)
		{
			...
			else if(sortedTypes[i] == 20)
			{}
			else if(sortedTypes[i] == 11)
			{
